...
static const UNICODE_STRING lsteamclient_us = RTL_CONSTANT_STRING( L"lsteamclient.dll" );
...
static BOOL import_dll( HMODULE module, const IMAGE_IMPORT_DESCRIPTOR *descr, LPCWSTR load_path, WINE_MODREF **pwm )
{
    ...
    if (lsteamclient && (!strcmp(name, "tier0_s64.dll") || !strcmp(name, "vstdlib_s64.dll")) && current_modref->ldr.BaseDllName.Buffer
